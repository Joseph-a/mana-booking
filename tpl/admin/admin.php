						...
						<div id="tabs">
							<div class="tab-title-box">
								<ul>
									...
									<li>
										<a href="#tabs-4"><?php esc_html_e( 'Social Icons', 'mana-booking' ) ?></a>
									</li>
									<li>
										<a href="#tabs-5"><?php esc_html_e( 'Slider & Gallery', 'mana-booking' ) ?></a>
									</li>
									<li>
										<a href="#tabs-6"><?php esc_html_e( 'Clients', 'mana-booking' ) ?></a>
									</li>
									<li>
														...
														foreach ( $options['currency'] as $index => $currency_item )
														{
															...
															<div class="currency-box currency-box-active <?php echo ( intval( $options['default_currency'] ) === $index ) ? esc_attr( 'default' ) : '' ?>">
																...
																<div class="mana-radiobox currency-default">
																	<label>
																		<input type="radio" name="mana-booking-setting[default_currency]" value="<?php echo esc_attr( $index ) ?>"
																			<?php
							...
							<div class="tab-content" id="tabs-4">
								<div class="l-col mana-col two-third clearfix">
									<div class="mana-box">
										<div class="field-rows fields clearfix">
											<div class="row">
												<label><?php esc_html_e( 'Twitter : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][twitter]" value="<?php echo ! empty( $options['social_icons']['twitter'] ) ? esc_attr( $options['social_icons']['twitter'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Facebook : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][facebook]" value="<?php echo ! empty( $options['social_icons']['facebook'] ) ? esc_attr( $options['social_icons']['facebook'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Google Plus : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][gplus]" value="<?php echo ! empty( $options['social_icons']['gplus'] ) ? esc_attr( $options['social_icons']['gplus'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Flickr : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][flickr]" value="<?php echo ! empty( $options['social_icons']['flickr'] ) ? esc_attr( $options['social_icons']['flickr'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Vimeo : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][vimeo]" value="<?php echo ! empty( $options['social_icons']['vimeo'] ) ? esc_attr( $options['social_icons']['vimeo'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Youtube : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][youtube]" value="<?php echo ! empty( $options['social_icons']['youtube'] ) ? esc_attr( $options['social_icons']['youtube'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Pinterest : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][pinterest]" value="<?php echo ! empty( $options['social_icons']['pinterest'] ) ? esc_attr( $options['social_icons']['pinterest'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Tumblr : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][tumblr]" value="<?php echo ! empty( $options['social_icons']['tumblr'] ) ? esc_attr( $options['social_icons']['tumblr'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Dribbble : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][dribbble]" value="<?php echo ! empty( $options['social_icons']['dribbble'] ) ? esc_attr( $options['social_icons']['dribbble'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Digg : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][digg]" value="<?php echo ! empty( $options['social_icons']['digg'] ) ? esc_attr( $options['social_icons']['digg'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Linkedin : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][linkedin]" value="<?php echo ! empty( $options['social_icons']['linkedin'] ) ? esc_attr( $options['social_icons']['linkedin'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Blogger : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][blogger]" value="<?php echo ! empty( $options['social_icons']['blogger'] ) ? esc_attr( $options['social_icons']['blogger'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Skype : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][skype]" value="<?php echo ! empty( $options['social_icons']['skype'] ) ? esc_attr( $options['social_icons']['skype'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Forrst : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][forrst]" value="<?php echo ! empty( $options['social_icons']['forrst'] ) ? esc_attr( $options['social_icons']['forrst'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Deviantart : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][deviantart]" value="<?php echo ! empty( $options['social_icons']['deviantart'] ) ? esc_attr( $options['social_icons']['deviantart'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Yahoo : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][yahoo]" value="<?php echo ! empty( $options['social_icons']['yahoo'] ) ? esc_attr( $options['social_icons']['yahoo'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Reddit : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][reddit]" value="<?php echo ! empty( $options['social_icons']['reddit'] ) ? esc_attr( $options['social_icons']['reddit'] ) : '' ?>"/>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Instagram : ', 'mana-booking' ) ?></label>
												<input type="text" name="mana-booking-setting[social_icons][instagram]" value="<?php echo ! empty( $options['social_icons']['instagram'] ) ? esc_attr( $options['social_icons']['instagram'] ) : '' ?>"/>
											</div>
										</div>
									</div>
								</div>
								<div class="r-col mana-col one-third pl clearfix">
									<div class="mana-info-box">
										<div class="header">
											<i class="dashicons dashicons-info"></i><?php esc_html_e( 'Instruction', 'mana-booking' ) ?>
										</div>
										<div class="content">
											<ol>
												<li><?php esc_html_e( 'You can add your social network addresses in these fields to be used in [mana-booking-social-icons] shortcode.', 'mana-booking' ) ?></li>
												<li><?php esc_html_e( 'If you do not want to show any icons, leave the field blank.', 'mana-booking' ) ?></li>
											</ol>
										</div>
									</div>
								</div>
							...
							<div class="tab-content" id="tabs-5">
								<div class="l-col mana-col two-third clearfix">
									<div class="mana-box">
										<div class="field-rows fields clearfix">
											<div class="row">
												<label><?php esc_html_e( 'Main Slider : ', 'mana-booking' ) ?></label>
												<div class="img-uploader-box">
													...
													<a href="#" class="button button-primary admin-img-uploader"><?php esc_html_e( 'Add / Update Images', 'mana-booking' ) ?></a>
													<a href="#" class="button button-primary admin-img-uploader clear-btn"><?php esc_html_e( 'Clear Images', 'mana-booking' ) ?></a>
													<input type="hidden" name="mana-booking-setting[main_slider]" class="img-field" value="<?php echo ! empty( $img_gallery_ids ) ? esc_attr( trim( $img_gallery_ids, ',' ) ) : ''; ?>">
												</div>
											</div>
											<div class="row">
												<label><?php esc_html_e( 'Gallery : ', 'mana-booking' ) ?></label>
												<div class="img-uploader-box">
													<div class="img-uploader clearfix">
														<?php
													...
													<a href="#" class="button button-primary admin-img-uploader"><?php esc_html_e( 'Add / Update Images', 'mana-booking' ) ?></a>
													<a href="#" class="button button-primary admin-img-uploader clear-btn"><?php esc_html_e( 'Clear Images', 'mana-booking' ) ?></a>
													<input type="hidden" name="mana-booking-setting[main_gallery]" class="img-field" value="<?php echo ! empty( $img_gallery_ids ) ? esc_attr( trim( $img_gallery_ids, ',' ) ) : ''; ?>">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="r-col mana-col one-third pl clearfix">
									<div class="mana-info-box">
										...
										<div class="content">
											<ol>
												<li><?php esc_html_e( 'You can manage the images of [mana-booking-main-slider] shortcode in this section.', 'mana-booking' ) ?></li>
												<li><?php esc_html_e( 'In the second item of this page, you can manage the images of [mana-booking-gallery] shortcode in this section.', 'mana-booking' ) ?></li>
											</ol>
										</div>
									</div>
								</div>
							...
							<div class="tab-content" id="tabs-6">
								<div class="l-col mana-col two-third clearfix">
												...
												foreach ( $options['client'] as $index => $client_item )
												{
													...
													<div class="client-box">
														...
														<div class="fields clearfix">
															<div class="row">
																<label><?php esc_html_e( 'Title : ', 'mana-booking' ) ?></label>
																<input type="text" name="mana-booking-setting[client][<?php echo esc_attr( $index ) ?>][title]" value="<?php echo ! empty( $client_item['title'] ) ? esc_attr( $client_item['title'] ) : '' ?>" placeholder="<?php esc_html_e( 'Title', 'mana-booking' ) ?>"/>
															</div>
															<div class="row">
																<label><?php esc_html_e( 'URL : ', 'mana-booking' ) ?></label>
																<input type="text" name="mana-booking-setting[client][<?php echo esc_attr( $index ) ?>][url]" value="<?php echo ! empty( $client_item['url'] ) ? esc_attr( $client_item['url'] ) : '' ?>" placeholder="<?php esc_html_e( 'http://', 'mana-booking' ) ?>"/>
															</div>
															<div class="row">
																<label><?php esc_html_e( 'Logo : ', 'mana-booking' ) ?></label>
																<div class="single-image-uploader">
																	...
																	<input type="hidden" name="mana-booking-setting[client][<?php echo esc_attr( $index ) ?>][logo]" value="<?php echo ! empty( $client_item['logo'] ) ? esc_attr( $client_item['logo'] ) : '' ?>"/>
																</div>
															</div>
														</div>
													</div>
									...
									<div class="add-client-box">
										<a class="client-add button button-primary button-large" href="#"><?php esc_html_e( 'Add New', 'mana-booking' ) ?></a>
									</div>
									<div class="client-box-tpl" style="display:none;">
										<div class="client-box">
											...
											<div class="fields clearfix">
												...
												<div class="row">
													<label><?php esc_html_e( 'URL : ', 'mana-booking' ) ?></label>
													<input type="text" name="" data-name="url" value="" placeholder="<?php esc_html_e( 'http://', 'mana-booking' ) ?>"/>
												</div>
												<div class="row">
													<label><?php esc_html_e( 'Logo : ', 'mana-booking' ) ?></label>
													<div class="single-image-uploader">
								...
								<div class="r-col mana-col one-third pl">
									<div class="mana-info-box">
										...
										<div class="content">
											<ol>
												<li><?php esc_html_e( 'You can add as much as client you need in this section.', 'mana-booking' ) ?></li>
												<li><?php esc_html_e( 'Clients you add here, will be generated by [mana-booking-client] shortcode.', 'mana-booking' ) ?></li>
												<li><?php esc_html_e( 'Please note that you must enter the url of clients with http://', 'mana-booking' ) ?></li>
											</ol>
										</div>
									</div>
								</div>
